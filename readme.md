...
| Module               | Method                     | Endpoint                  | Full URL                                                                    | Auth | Status               |
| -------------------- | -------------------------- | ------------------------- | --------------------------------------------------------------------------- | ---- | -------------------- |
| Health               | GET                        | `/api/health/`            | `https://ai-study-task-planner-backend.onrender.com/api/health/`            | No   | Working              |
| Register             | POST                       | `/api/accounts/register/` | `https://ai-study-task-planner-backend.onrender.com/api/accounts/register/` | No   | Working              |
| Login                | POST                       | `/api/accounts/login/`    | `https://ai-study-task-planner-backend.onrender.com/api/accounts/login/`    | No   | Working              |
| Profile              | GET / PUT / PATCH          | `/api/accounts/profile/`  | `https://ai-study-task-planner-backend.onrender.com/api/accounts/profile/`  | Yes  | Working              |
| Logout               | POST                       | `/api/accounts/logout/`   | `https://ai-study-task-planner-backend.onrender.com/api/accounts/logout/`   | Yes  | Working              |
| Courses              | GET / POST                 | `/api/courses/`           | `https://ai-study-task-planner-backend.onrender.com/api/courses/`           | Yes  | Working              |
| Course Detail        | GET / PUT / PATCH / DELETE | `/api/courses/<id>/`      | `https://ai-study-task-planner-backend.onrender.com/api/courses/<id>/`      | Yes  | Working              |
| Tasks                | GET / POST                 | `/api/tasks/`             | `https://ai-study-task-planner-backend.onrender.com/api/tasks/`             | Yes  | Working              |
| Task Detail          | GET / PUT / PATCH / DELETE | `/api/tasks/<id>/`        | `https://ai-study-task-planner-backend.onrender.com/api/tasks/<id>/`        | Yes  | Working              |
| Task Filter          | GET                        | `/api/tasks/filter/`      | `https://ai-study-task-planner-backend.onrender.com/api/tasks/filter/`      | Yes  | Working              |
| Progress             | GET                        | `/api/progress/`          | `https://ai-study-task-planner-backend.onrender.com/api/progress/`          | Yes  | Working              |
| AI Home              | GET                        | `/api/ai/`                | `https://ai-study-task-planner-backend.onrender.com/api/ai/`                | No   | Working              |
| AI Study Plan        | POST                       | `/api/ai/study-plan/`     | `https://ai-study-task-planner-backend.onrender.com/api/ai/study-plan/`     | Yes  | Implemented          |
| AI Priority          | POST                       | `/api/ai/priority/`       | `https://ai-study-task-planner-backend.onrender.com/api/ai/priority/`       | Yes  | Implemented          |
| AI Task Breakdown    | POST                       | `/api/ai/task-breakdown/` | `https://ai-study-task-planner-backend.onrender.com/api/ai/task-breakdown/` | Yes  | Implemented          |
| AI Chat              | POST                       | `/api/ai/chat/`           | `https://ai-study-task-planner-backend.onrender.com/api/ai/chat/`           | Yes  | Optimization Pending |
| Saved AI Plans       | GET / POST                 | `/api/ai/plans/`          | `https://ai-study-task-planner-backend.onrender.com/api/ai/plans/`          | Yes  | Implemented          |
| Saved AI Plan Detail | GET / PATCH / DELETE       | `/api/ai/plans/<id>/`     | `https://ai-study-task-planner-backend.onrender.com/api/ai/plans/<id>/`     | Yes  | Implemented          |
